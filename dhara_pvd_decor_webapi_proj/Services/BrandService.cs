...
namespace dhara_pvd_decor_webapi_proj.Services
{
    public class BrandService : IBrandService
    {
        ...
        public async Task<int> AddBrand(AddBrandRequest request)
        {
        ...
        public async Task<int> DeleteBrand(long id)
        {
            var connectionString = _configuration.GetConnectionString("DefaultConnection");
        ...
        public async Task<List<Brand_list>> GetBrandList()
        {
            var list = new List<Brand_list>();
            var connectionString = _configuration.GetConnectionString("DefaultConnection");
            ...
            using (var connection = new SqlConnection(connectionString))
            {
                ...
                using (var command = new SqlCommand("sp_brand_mast_ins_upd_del", connection))
                {
                    command.CommandType = CommandType.StoredProcedure;
        ...
        public async Task<Single_Brand_list?> GetBrandById(long id)
        {
        ...
        public async Task<List<drop_Brand_list>> GetDropBrandList()
        {
            var list = new List<drop_Brand_list>();
            var connectionString = _configuration.GetConnectionString("DefaultConnection");
